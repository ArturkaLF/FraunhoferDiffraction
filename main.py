...
def onButtonAddClicked(event):
    ...
    img = Image.open('/Users/artur/Python/NeuralNetwork/src/DiffractionGraph/' + str(number) + '.jpg')
    img.show()
    number += 1
...
files = glob.glob('/Users/artur/Python/NeuralNetwork/src/DiffractionGraph/*')
files.remove('/Users/artur/Python/NeuralNetwork/src/DiffractionGraph/Final.py')
if files:
    for f in files:
        os.remove(f)
